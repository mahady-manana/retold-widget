...
export default function DarkTestimonial2({
  testimonial,
  contentLines,
}: TestimonialItemType) {
      ...
      <div className="h-full flex flex-col justify-between relative rounded-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-6 border border-gray-700">
        ...
        {hasTextContent && (
          <TruncatedContent
            ...
            className=" text-gray-300 mb-5  italic border-l-4 border-cyan-500 pl-4 bg-gray-800/50 py-2 pr-3 rounded-r-lg"
          />
        )}
        {(hasVideo || hasAudio) && (
          <>
        ...
        <div className="flex items-center border-t border-gray-700 pt-4 justify-between">
